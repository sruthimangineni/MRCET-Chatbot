...
train_x_array = [item[0] for item in training]
train_y_array = [item[1] for item in training]
...
model = Sequential([
    # First layer with 128 neurons and ReLU activation
    Dense(128, activation='relu', input_shape=(len(train_x[0]),)),
    Dropout(0.5),
    # Second layer with 64 neurons and ReLU activation
